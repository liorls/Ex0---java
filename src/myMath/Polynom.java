...
public class Polynom implements Polynom_able{
	...
	public void add(Polynom_able p1)
	{
		...
		Iterator<Monom> otherIterator = p1.iterator();
		boolean isFound;
	...
	public void substract(Polynom_able p1)
	{
		...
		Iterator<Monom> otherIterator = p2.iterator();
		while (otherIterator.hasNext())
		{
			Monom current = otherIterator.next();
	...
	{
		Iterator<Monom> thisIterator = iterator();
		Iterator<Monom> otherIterator = p1.iterator();
	...
	private ArrayList<Monom> expression = new ArrayList<Monom>();
